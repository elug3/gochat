...
func (x *CreateCredentialsRequest) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *CreateCredentialsResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
const file_auth_proto_rawDesc = "" +
	...
	"\x19CreateCredentialsResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess2\x95\x01\n" +
	"\vAuthService\x12T\n" +
	"\x11CreateCredentials\x12\x1e.auth.CreateCredentialsRequest\x1a\x1f.auth.CreateCredentialsResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB'Z%github.com/elug3/api/grpc/auth;authpbb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*CreateCredentialsRequest)(nil),  // 2: auth.CreateCredentialsRequest
	(*CreateCredentialsResponse)(nil), // 3: auth.CreateCredentialsResponse
}
var file_auth_proto_depIdxs = []int32{
	2, // 0: auth.AuthService.CreateCredentials:input_type -> auth.CreateCredentialsRequest
	0, // 1: auth.AuthService.Login:input_type -> auth.LoginRequest
	3, // 2: auth.AuthService.CreateCredentials:output_type -> auth.CreateCredentialsResponse
